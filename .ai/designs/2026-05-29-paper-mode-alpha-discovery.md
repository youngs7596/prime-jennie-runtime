...
> **2026-06-19 현황 — 실보유 0, 명분 재검토 보류**: 코스피 급락에 운영자가 KODEX 200
> 1,568주를 HTS 로 직접 전량 청산했다. v3 가 매매하지 않고 동결해 두던 실보유가 0이
> 됐고 실계좌엔 현금만 남았다 (순자산 약 2.36억). 위 §1.1 이 적던 "실계좌 보유 6종목
> 동결" 은 더 이상 사실이 아니다. 실계좌를 유지하던 명분 두 가지 중 "유사시 보유 주식
> 처분" 은 처분할 대상이 사라져 없어졌고, 남은 명분은 6-12 의 사람-승인 매매 통로뿐이다.
> 실계좌를 계속 둘지 (= 사람-승인 매매를 실제로 쓸 것인가) 아니면 모의계좌로 분리할지
> (5-29 민지 권고) 는 운영자 결정 대기로 보류한다. 측정·벤치마크 (KODEX 200 가상 BUY &
> HOLD 대비) 는 실보유와 무관해 영향 없다.
